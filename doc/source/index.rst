...
.. grid:: 2 2 3 3
    ...
    .. grid-item-card:: :fa:`info-circle` Learn what PyMechanical-MCP is
        :link: user_guide/overview
        :link-type: doc

        Discover what PyMechanical-MCP is, how it works, and why you should use it.
    ...
    .. grid-item-card:: :fa:`book-open-reader` Use the API reference
        ...
        Access complete reference documentation for all MCP tools.

    .. grid-item-card:: :fa:`cogs` Explore available tools
